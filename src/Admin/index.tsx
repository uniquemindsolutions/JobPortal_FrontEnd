        ...
        <>
            <div className="admin-container">
                ...
                <div className="w-100 px-3">
                    <header className="dash-head sticky-top shadow-sm d-flex justify-content-between align-items-center p-3">
                        {/* Search Bar */}
                        ...
                        <div className="position-relative">
                            ...
                            <Link to="submit-job" className="btn btn-lg btn-outline-primary ms-4"
